...
const SubFooter = () => {
  return (
    <section className="mobile md:tablet xl:desktop flex flex-col justify-center md:flex-row md:justify-between md:items-center xl:space-x-[3.2rem] lg:space-x-[2.2rem] md:space-x-[1rem]">
